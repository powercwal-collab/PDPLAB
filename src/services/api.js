...
export const api = {
  ...
  updateProject: (projectId, payload) => request(`/api/projects/${projectId}/`, json('PATCH', payload)),
  deleteProject: (projectId) => request(`/api/projects/${projectId}/`, { method: 'DELETE' }),
  deleteProjects: (projectIds) => request('/api/projects/batch-delete/', json('POST', { project_ids: projectIds })),
