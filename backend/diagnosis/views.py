...
def diagnosis_config(request):
    ...
    return JsonResponse({
        ...
        "source_spec_version": rules.get("source_spec_version", ""),
        ...
        "scoring_rules": {
            ...
            "adjudication_protocol": rules.get("adjudication_protocol", DEFAULT_SCORING_RULES.get("adjudication_protocol", [])),
            "score_semantics": rules.get("score_semantics", DEFAULT_SCORING_RULES.get("score_semantics", {})),
            "boundary_locks": rules.get("boundary_locks", DEFAULT_SCORING_RULES.get("boundary_locks", {})),
            ...
            "regression_cases": rules.get("regression_cases", DEFAULT_SCORING_RULES.get("regression_cases", {})),
        },
